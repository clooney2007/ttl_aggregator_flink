...
public class CustomSocketTextStreamFunction implements SourceFunction<String> {
    ...
    public CustomSocketTextStreamFunction(String hostname, int port, String delimiter, long maxNumRetries) {
        this(hostname, port, delimiter, maxNumRetries, DEFAULT_CONNECTION_RETRY_SLEEP);
    }

    public CustomSocketTextStreamFunction(String hostname, int port, String delimiter, long maxNumRetries, long delayBetweenRetries) {
    ...
    public void run(SourceContext<String> ctx) throws Exception {
        ...
        while (isRunning) {
            ...
            try (Socket socket = new Socket()) {
                ...
                LOG.info("Custom SourceFunction: Connecting to server socket " + hostname + ':' + port);
